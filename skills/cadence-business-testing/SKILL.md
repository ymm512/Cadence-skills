...
description: Use when generating business test cases based on requirements and design. Creates Happy Path, Exception and Boundary Value test cases, automation scripts (Jest/Playwright), and test documentation. Usually activated by cadence-orchestrator.
---
