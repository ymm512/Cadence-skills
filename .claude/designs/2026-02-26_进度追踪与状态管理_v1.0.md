...
- Subagent Development 最多支持 49 个并发（默认 5 个）
...
- [Superpowers - verification-before-completion](https://github.com/jessev/superpowers/blob/main/skills/verification-before-completion/SKILL.md)
- [Superpowers - subagent-driven-development](https://github.com/jessev/superpowers/blob/main/skills/subagent-driven-development/SKILL.md)
