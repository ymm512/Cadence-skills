...
│   │
│   ├── cadence-receiving-code-review/    # ✨ 新增
│   │   ├── SKILL.md                      # 接收审查反馈
│   │   └── README.md                     # 响应审查指南
│   │
│   ├── cadence-self-review/              # ✨ 新增
│   │   ├── SKILL.md                      # 自审技能
│   │   ├── checklist.md                  # 自审清单
│   │   └── examples.md                   # 示例
│   │
...
│   │   └── SKILL.md                      # 节点7：隔离环境
│   │
│   ├── cadence-subagent-development/     # ⭐ 核心节点
│   │   ├── SKILL.md                      # Skill定义
│   │   ├── README.md                     # 使用说明
...
| 分类 | 数量 | 说明 | 必需性 | 使用场景 |
|------|------|------|-------|---------|
| 🧬 **元Skill** | 1 | using-cadence入口Skill | 必须加载 | 会话开始时 |
| 🔧 **前置Skill** | 5 | 质量保证基础 | 特定场景必须 | 开发流程中按需调用 |
| 📋 **节点Skill** | 11 | 11个核心节点 | 按需调用 | 流程节点 |
| 🔀 **流程Skill** | 3 | 流程组合 | 按需调用 | 完整流程执行 |
| ✅ **支持Skill** | 2 | 辅助功能 | 可选 | 特定场景 |
...
| `cadence-receiving-code-review` | 接收审查反馈 | 收到审查意见后 |
| `cadence-self-review` | 自我审查 | 每个 task 完成后 |
...
| 9 | `cadence-test-design` | 集成测试方案 |
| 10 | `cadence-integration` | 集成测试 |
| 11 | `cadence-deliver` | 交付 |
...
| Skill | 包含节点 | 适用场景 |
|-------|---------|---------|
| `cadence-full-flow` | 1-11 全部节点 | 企业级项目、完整流程 |
| `cadence-quick-flow` | 3,4,6,7,8,11 | 快速迭代、小型功能 |
| `cadence-exploration-flow` | 1,4,6,7,8 | 技术探索、原型开发 |
...
| Skill | 用途 | 触发条件 |
|-------|------|---------|
| `cadence-verification-before-completion` | 交付前验证 | Deliver 节点完成后 |
...
### 5.2 🔧 前置Skill: cadence-using-git-worktrees
...
### 5.3 🔧 前置Skill: cadence-test-driven-development
...
### 5.4 🔧 前置Skill: cadence-requesting-code-review
...
### 5.5 🔧 前置Skill: cadence-receiving-code-review（✨新增）
...
### 5.6 🔧 前置Skill: cadence-self-review（✨新增）
